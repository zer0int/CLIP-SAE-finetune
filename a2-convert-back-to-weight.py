...
from clip.model import CLIP  # Make sure this imports the original CLIP class definition
import os

"""
Converting Geometric Parametrization (GmP) back to .weight so it's a 'normal model'.
After conversion, the model can be used in downstream tasks, e.g. with 'import clip'.
"""
...
torch.save(original_model, 'ft-checkpoints/clip_ft_20_backtoweight.pt')
